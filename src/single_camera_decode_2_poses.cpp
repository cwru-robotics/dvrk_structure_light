...
int main( int argc, char** argv )
{
  ...
  String images_file ="/home/ammarnahari/dvrk_ws/src/dvrk_structure_light/param/single_cam_2_poses_data.yaml";
  String cam1_intrinsics_file="/home/ammarnahari/ros_ws/src/dvrk_structure_light/param/tilted_left_cam_intrinsics.txt";
  ...
  intrinsic_file_read(cam1_intrinsics_file,&cam1intrinsics,&cam1distCoeffs);

  intrinsic_file_read(cam1_intrinsics_file,&cam2intrinsics,&cam2distCoeffs);
  R= (
    Mat_<double>(3,3)<<
  ...
  T= (Mat_<double>(3,1) << 0.0,0.0, -0.030);
